...
(function () {
  ...
  var ZH = {
    ...
    "w5.t":"醫學藥理、奈米科技與生物標記",
    "w5.in":"奈米科技、液態切片與生物標記，從 NanoVelcro 晶片到數位分身（Hsian-Rong Tseng，UCLA／David Geffen 醫學院）；匯流生科與生醫創新（吳家樂）。",
    "w5.out":"生物標記或數位分身的迷你提案：問題、資料、方法與風險。",
    "w6.t":"數位健康與創新",
    "w6.in":"Bijan Najafi（UCLA／David Geffen 醫學院）的數位健康、穿戴裝置與遠距監測，並參訪 CASIT／IDEAS 實驗室；Nikita Bedi 的頭頸癌手術 AI；王康隆的量子系統與半導體現況；Yuan Tian（UCLA）的 AI 資安與隱私、如何防範代理程式（agent）失控；Taboola 企業參訪；以及 Li-Fan Lu（UC San Diego）的免疫學與調節型 T 細胞。",
    "w6.out":"數位健康原型：使用者旅程、資料流，以及倫理與隱私考量。",
    "w7.t":"整合醫學與傳統中醫",
    "w7.in":"顏宏融（中國醫藥大學）的中醫、整合醫學、草藥、針灸與舌脈診；顏志學的人造鑽石成長與鑽石量子感測；Greg Zimmerman 的針灸與艾灸；Ka-Kit Hui（UCLA 中西醫結合中心）的中西整合醫學；以及 City of Hope 參訪。",
    "w7.out":"整合醫學的證據地圖：傳統與現代醫學如何彼此啟發與驗證。",
    "w8.t":"量子科學／應用量子",
    "w8.in":"應用量子科學與一場業界客座分享；從硬體到演算法的量子平台（Roger Luo，Anyon Computing）；量子資訊與應用量子科學，以及科技政策與職涯（周立偉，國科會駐洛杉磯科技組）；並到加州大學聖地牙哥分校與 BioLegend 參訪。",
    ...
    "w3.log":"黃光旭老師以光子、電子、量子與 AI 四大支柱串起一整套生醫技術棧：光學切片、光聲影像結合光遺傳學、體內奈米機器人，以及用於癌症與類澱粉蛋白早期偵測的 NV 鑽石量子感測器，最後收在「錯誤更正」這條主線——量子的錯誤更正、深睡時大腦清除類澱粉的類淋巴系統，以及把困境化為智慧的成長，共通點都是能自我修正。C.Y. Daniel Lee 帶我們認識動物模式與建構、表面、預測三種效度，接著談阿茲海默症的遺傳學，以及主導小膠質細胞清除斑塊的 TREM2 受體。Hong-Zong Lin 則以預測式 AI 為這週收尾：臨床資料為何「小而寬」，以及完整貝氏推論如何保留因果與相依特徵，支撐即時的數位分身。",
    "w5.log":"Hsian-Rong Tseng 帶我們認識奈米科技與液態切片：NanoVelcro 晶片捕捉循環腫瘤細胞的五個世代、經點擊化學轉向細胞外囊泡（EV）的策略，以及從癌症到產前篩檢的應用。他從芥子毒氣談到化療的起源，展望病人的「數位分身」，並提醒我們：真正的成功，是技術走進臨床、真正幫到病人。吳家樂則以「匯流生科與生醫創新」替本週收尾。",
    "w6.log":"Bijan Najafi 以數位健康開場，認為真正的突破往往發生在不同領域的交界，好的穿戴裝置必須簡單到能天天使用；他展示了為高齡社會打造的居家「近身」感測器與脆弱度量表，並帶我們參訪他的 CASIT／IDEAS 實驗室。Nikita Bedi 展示手術 AI 如何把一台頭頸癌手術拆解成標註好的階段，讓模型能從手術影片中學習。王康隆把量子行為連回真實的半導體，從非線性、鍺到矽的取捨，到「3 奈米」究竟代表什麼、以及拓樸材料為何重要。Yuan Tian 談 AI 資安，以推論階段的「引導」（steering）而非昂貴的重新訓練，來抵禦越獄與提示注入攻擊。Taboola 參訪讓我們看見大規模的推薦式 AI，乾淨的資料才是真正的燃料。Li-Fan Lu 以免疫學與調節型 T 細胞替本週收尾，從 Foxp3 與周邊免疫耐受，一路談到 2025 年諾貝爾獎與 CAR-T reg 細胞。",
    "w7.log":"顏宏融把陰陽詮釋為一種動態平衡而非固定的東西，帶我們走過望、聞、問、切四診——透過舌象與脈象推估體內狀況——再示範台灣的中醫資料庫與 AI「醫師分身」如何標記中西藥交互作用、為病人量身打造整合式治療。顏志學說明人造鑽石如何以 CVD（化學氣相沉積）而非高溫高壓法生長，以及氮—空位（NV）中心為何能讓鑽石同時成為室溫量子位元與極靈敏的磁場感測器。Greg Zimmerman 以經絡理論介紹針灸與艾灸，強調傳統療法應以樸實、有生物學根據的語言說明，而非比喻，且醫療的可近性與保險給付和技術本身同樣重要。Ka-Kit Hui 以中西整合醫學收束本週，代表團並參訪 City of Hope，近距離觀摩轉譯癌症研究。",
    "w8.log":"第八週把量子這條主線收攏起來。應用量子的幾堂課從一開始的基礎，走到量子真正用得上的地方，涵蓋運算、模擬、感測與通訊，還有一場業界的客座分享。Anyon Computing 的 Roger Luo 帶我們從硬體一路看到演算法，說明要把脆弱的量子位元變成一台能動的機器有多不容易，以及為什麼現在混合量子與古典的系統這麼重要。國科會駐洛杉磯科技組的周立偉組長，把科學接回政策和職涯，也談台灣怎麼支持想投入這個領域的學生。課程之間，各組也為期末專題做了草稿診斷；本週最後到聖地牙哥，參訪加州大學聖地牙哥分校和生技公司 BioLegend，提醒我們計畫裡量子和生醫這兩條線，最後都會在真實世界交會。",
    "w4.log":"Richard Ross 以量子資訊為第四週開場：機率幅、以電壓閘極困住單一電子的量子點，以及一經測量就可能坍縮的糾纏。接著 Anita Wu 帶我們認識肝素硫酸：決定結合對象的關鍵在硫酸化模式而非醣骨架本身，化學合成正指向癌症免疫治療；Yun Chiu 以食慾素（orexin）與 TRPV1 描繪斑馬魚睡眠迴路。Marko Sokolich 從半導體微奈米製程講起：先摻雜，再逐層反覆沉積、微影與蝕刻，直到薄膜低於 1 奈米、電子穿隧漏電的極限。Yang Yang 帶我們從效率逼近 27% 的研究級鈣鈦礦太陽能電池，一路談到讓元件衰退的高溫、濕氣與氧氣，並收在「失敗就是過程的一部分」。Gina Poe 談只有睡眠才能完成的記憶固化，Nardo 則以深科技創投、基礎設施與創辦團隊為這週收尾。",
    ...
    "fac.ng.r":"亞洲大學 · 生物資訊與醫學工程學系教授","fac.ng.a":"生物資訊、系統生物學、癌症基因體學與生物網路分析；跨領域生醫科學與生醫創新。",
    "fac.zimmerman.r":"執業針灸師（L.Ac.）· 古典中醫本草與針灸","fac.zimmerman.a":"古典中醫本草、針灸與辨證論治；Retreat Acupuncture 臨床主任，中國醫藥大學博士研究生。",
