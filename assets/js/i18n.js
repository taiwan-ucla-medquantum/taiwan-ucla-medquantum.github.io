...
(function () {
  ...
  var ZH = {
    ...
    "fac.iris.r":"計畫 · 學術顧問暨課程協調","fac.iris.a":"數學家、認證資料科學家暨教育者，專長風險管理、資訊安全、量化分析、因果推論與應用機器學習。","fac.iris.more":"於加州州立大學洛杉磯分校自然與社會科學學院數學系、商業與經濟學院資訊系統系擔任兼任教授；並於哈佛進修部進修資料科學，以及普渡大學 Purdue Polytechnic Institute 的 Doctor of Technology 學程攻讀博士。","more.open":"展開","more.close":"收合",
    ...
    "del.lee.s":"國立清華大學 · 物理（天文物理）與電機資訊","del.wang.s":"陽明交通大學 · 智慧醫療電子工程研究所","del.liu.s":"亞洲大學 · 聽力暨語言治療學系","del.chen.s":"芝加哥大學 · 應用資料科學","del.hsieh.s":"馬偕醫學院 · 醫學系","del.pan.s":"多倫多大學 · 藥理與毒理學（碩士）","del.clee.s":"國立臺灣大學 · 醫學院生理學","del.cheng.s":"牛津大學 · 博士候選人",
